...
# Version 1.3.4 UX requirements.
check("Version 1.3.4 is configured", "APP_VERSION = '1.3.4'" in js and dataset.get("app_version") == "1.3.4")
...
# Version 1.3.4 transaction-analysis and independently audited measurement-period requirements.
...
check("App version 1.3.4 is in dataset", dataset.get("app_version") == "1.3.4")
